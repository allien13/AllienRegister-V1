...
.setDescription(`${member} kişisi <@&${ayar.kadın}> olarak kaydedildi. <a:allien_onay:838085541551538218> 
...
.setFooter(`${message.author.tag} toplam ${kayıtlar} kayıta sahip. | allien Was Here !`)
.setColor('0x2f3136')
.setTimestamp())
